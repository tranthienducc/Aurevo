import { ArrowShape } from "@/redux/slices/shaped";
...
const Arrow = ({ shape }: { shape: ArrowShape }) => {
  ...
  const maxX = Math.min(startX, endX, arrowHead.x1, arrowHead.x2) + 5;
  const maxY = Math.min(startY, endY, arrowHead.y1, arrowHead.y2) + 5;
