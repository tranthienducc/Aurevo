  ...
  return (
    <div className="col-span-1 flex justify-start items-center">
      <div
        ...
        aria-hidden
      >
        <span className="inline-grid size-6 place-items-center rounded-full hover:bg-white/[0.12] transition-all cursor-pointer">
          <Undo2 className="opacity-80 stroke-[1.75]" size={18} />
        </span>

        <span className="mx-1 h-5 w-px rounded bg-white/[0.16]" />
        <span className="inline-grid size-9 place-items-center rounded-full hover:bg-white/[0.12] transition-all cursor-pointer">
