...
const generateGradientThumbnail = () => {
  ...
  <stop offset="0%" style="stop-color:${randomGradient.match(/#[a-fA-F0-9]{6}/g)?.[1] || "#764ba2"}" />
  </linearGradient>
  </defs>
  <rect width="100%" height="100%" fill="url(#grad)"/>
  <circle cx="150" cy="100" r="30" fill="white" opacity="0.8" />
  <path d='M140 90 L160 90 L160 110 L140 100 Z' fill="white" opacity="0.6" />
  </svg>
  `;
...
export const useProjectCreation = () => {
  ...
  console.log("user-in-use-project-hooks", user);
